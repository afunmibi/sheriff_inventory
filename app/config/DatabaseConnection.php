 ...
 * Singleton pattern with transaction support and prepared statements
 */
...
class DatabaseConnection {
    ...
    private static function connect(): void {
        ...
        try {
            ...
            if (self::$connectionAttempts < self::MAX_RETRY_ATTEMPTS) {
                $delay = pow(2, self::$connectionAttempts);
                sleep($delay);
                self::connect();
            } else {
                throw new Exception("Database connection failed after " . self::MAX_RETRY_ATTEMPTS . " attempts: " . $e->getMessage());
            }
        }
    }
    ...
    public static function getConnection(): mysqli {
        ...
        if (!self::$instance || self::$instance->ping() === false) {
            self::$instance = null;
            new self();
        }
    ...
    public function inTransaction(): bool {
        ...
        return isset($conn->in_transaction) ? $conn->in_transaction : false;
    }
